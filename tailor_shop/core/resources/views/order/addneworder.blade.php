			...
			<form action="{{url('admin/save-order')}}" class="form-horizontal" method="POST">
				...
				<div class="form-body">
					 {{ csrf_field() }}
						...
						<!--Start Customer Area-->
							<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Customer Info</button>
						   ...
						   <div class="form-body">
							<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#mes1">Measurement</button>
							<div id="mes1" class="collapse"/>
							</br>
							<div class="row">
					            <div class="col-md-6">
						            <!-- text input -->
					                <div class="form-group">
					                  <label class="control-label col-md-4">Crop Top:</label>
					                  	<div class="col-md-8">
					                  		<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_croptop" id="service_cus_croptop">
					                	</div>
					           		</div> 
					                ...
					                <div class="form-group">
					                  <label class="control-label col-md-4">Upper Chest :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_upperchest" id="service_cus_upperchest">
					                	</div>
					                </div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Waist :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_waist" id="service_cus_waist">
					                	</div>
					                </div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Hip :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_hip" id="service_cus_hip">
					                	</div>
					                </div>
						        <div class="form-group">
					                  <label class="control-label col-md-4">Sleeves length :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_sleeveslength" id="service_cus_sleeveslength">
					                	</div>
					                </div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Arms Fold :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_armsfold" id="service_cus_armsfold">
					                	</div>	
									</div>
					              <div class="form-group">
					                  <label class="control-label col-md-4">Front Sholulder :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_frontshoulder" id="service_cus_frontshoulder">
					                	</div>	
									</div>
					            </div> 
								...
								<div class="col-md-6">
					                ...
					                <div class="form-group">
					                  <label class="control-label col-md-4">Full Length :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_fulllength" id="service_cus_fulllength">
					                	</div>
					                </div>
								<div class="form-group">
					                  <label class="control-label col-md-4">Chest :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_chest" id="service_cus_chest">
					                	</div>
					                </div>
								</div>
					            ...
					            <div class="col-md-6">
					                ...
					                <div class="form-group">
					                  <label class="control-label col-md-4">Chest Point :</label>
					                  	<div class="col-md-8">
					                  		<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_chestpoint" id="service_cus_chestpoint">
					                	</div>
					           		</div> 
					                ...
					                <div class="form-group">
					                  <label class="control-label col-md-4">Shoulder :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_shoulder" id="service_cus_shoulder">
					                	</div>
					                </div>
					              ...
					              <div class="form-group">
					                  <label class="control-label col-md-4">Sleeves Loose :</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_sleevesloose" id="service_cus_sleevesloose">
					                	</div>
					                </div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Neck F/B:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_neck" id="service_cus_neck">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Chudidar:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_chudidar" id="service_cus_chudidar">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Salvar:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_salvar" id="service_cus_salvar">
					                	</div>
									</div>										
							...
							<div class="form-group">
					                  <label class="control-label col-md-4">Blouse:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_blouse" id="service_cus_blouse">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Dress:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_dress" id="service_cus_dress">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Skirt:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_skirt" id="service_cus_skirt">
					                	</div>
					                	</div>
					                	</div>
								...
								<div  class="col-md-6">
							        <div class="form-group">
					                  <label class="control-label col-md-4">Saree:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_saree" id="service_cus_saree">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">Fall:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_fall" id="service_cus_fall">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">pico:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_pico" id="service_cus_pico">
					                	</div>
									</div>
									<div class="form-group">
					                  <label class="control-label col-md-4">knots:</label>
					                  	<div class="col-md-8">
					                	  	<input type="text" class="form-control" placeholder="Enter ..." name="service_cus_knots" id="service_cus_knots">
					                	</div>
									</div>
								</div>
						    </div>
					...
					<div class="row serviceRow redBorder"  id="orderBox">
						...
						<div class="row pading-margin-zero">
							<div class="col-md-12 col-md-offset-1">
								<div class="form-group">
									<div class="col-md-10" >
										<textarea type="text" class="form-control service_measer" placeholder=" ..." name="service_measer[]"></textarea>
									</div>
								</div>
							</div>
						</div>
